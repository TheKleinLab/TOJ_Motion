...
data in the database to text files found in TOJ_Motion/ExpAssets/Data.
...
CREATE TABLE trials (
	...
	toj_condition text not null,
	trial_type text not null,
	target_type text not null,
	t1_location text not null,
	t1_type text not null,
	upper_target text not null,
